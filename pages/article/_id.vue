<template>
	<article id="article" ref="article">
		<Header title="文章阅读" type="index"></Header>
...
import Reward from '@/components/Web/Reward'
export default {
	data () {
		return {
			article_show: false,
	...
	head () {
		...
		return {
			title: '文章阅读 | 二次猿',
			meta: [
				{ hid: 'description-article', name: 'description', content: '二次猿，二次猿博客，二次猿的技术博客，文章阅读' },
				{ hid: 'description-article-description', name: 'description', }
			]
		}
	},
	// async mounted () {
